...
<div class="row">
   <div class="span10">
      ...
      <hr />
      <p>
         Aggregation become very relevant when you use several plugins in the same table. Compression too :-)
      </p>
   </div>
   <div class="span10">
      <h4>Example</h4>
...
<%-- Documentation --%>
<doc:doc source="plugins/comboaggregcompress.jsp" doc="plugins.comboaggreg.html" />