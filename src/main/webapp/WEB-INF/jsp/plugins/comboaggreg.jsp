...
<div class="row">
   ...
   <div class="span10">
      <h4>Example</h4>
      <p>
         <strong>ColReorder</strong> and <strong>Scroller</strong> have been activated in the following table. Aggregation too. Take a look at the generated web resources to see what changed.
      </p>
      <p>
