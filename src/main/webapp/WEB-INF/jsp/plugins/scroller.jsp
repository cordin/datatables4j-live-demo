   ...
   <div class="span2">
      <div class="well sidebar-nav">
         <ul class="nav nav-list">
            ...
            <li class="active"><a href="${plugins}/scroller">Scroller</a></li>
   ...
   <div class="span10">
      ...
      <div class="row">
         ...
         <div class="span10">
            <h4>Usage</h4>
            <p>
               You just need to set the <tt>scroller</tt> table attribute to <tt>true</tt> to activate the Scroller plugin.
            </p>
            <p>
         ...
         <div class="span10 bs-docs-example">
            <p>
               Take a look at the JSP : <tt>WEB-INF/jsp/plugins/scroller.jsp</tt>
            </p>
            <p>
<pre class="prettyprint">
&lt;datatables:table id="toto" data="&#36;&#123;persons&#125;" scroller="true"&gt;
   &lt;datatables:column title="Id" property="id" /&gt;
   &lt;datatables:column title="FirstName" property="firstName" /&gt;
   &lt;datatables:column title="LastName" property="lastName" /&gt;
   &lt;datatables:column title="Street" property="address.street1" /&gt;
