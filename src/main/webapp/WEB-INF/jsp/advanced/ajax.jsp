...
<div class="row-fluid">
   <div class="span12">
      ...
      <h4>Example</h4>
      <p>
      If you browse the demo application sources, you\'ll see that the Spring MVC AJAX features are used (since [Spring
      3.0](http://blog.springsource.org/2010/01/25/ajax-simplifications-in-spring-3-0/ "Jackson")).
      
      <pre class="prettyprint">
      @RequestMapping(value="/personsWs", method = RequestMethod.GET) public @ResponseBody List
      <Person> getPersons(){ return personService.get1000(); } So, all you need to do is to set the REST WS url
      in the <code>url</code> attribute : 
      </Person>
      </pre>
   </div>
</div>
