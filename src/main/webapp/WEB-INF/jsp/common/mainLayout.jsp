    ...
    <div class="navbar-inner">
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    <li class="<tiles:getAsString name="tabHome" />"><a href="${home}"><i class="icon-home"></i>
                        Home</a></li>
                    <li class="dropdown <tiles:getAsString name="tabBasic" />">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-leaf"></i> Basic<b
                                class="caret"></b></a>
                    ...
                    <li class="dropdown <tiles:getAsString name="tabDatasource" />">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-hdd"></i> Datasource<b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown <tiles:getAsString name="tabAdvanced" />">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-fire"></i> Advanced<b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown <tiles:getAsString name="tabPlugins" />">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-plus"></i> Plugins<b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown <tiles:getAsString name="tabFeatures" />">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-list"></i> Features<b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-search"></i> Help <b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="https://github.com/datatables4j/datatables4j-core/issues">Issues /
                                Enhancements</a></li>
...
<div class="container">
    ...
    <hr/>
    <footer>
        <p>DataTables4j - v0.6.0-SNAPSHOT</p>
    </footer>
